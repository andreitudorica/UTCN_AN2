...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/Andrei/Scoala/CA/TudoricaAndrei/test_env/test_env.cache/wt [current_project]
  set_property parent.project_path D:/Andrei/Scoala/CA/TudoricaAndrei/test_env/test_env.xpr [current_project]
  set_property ip_output_repo D:/Andrei/Scoala/CA/TudoricaAndrei/test_env/test_env.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet D:/Andrei/Scoala/CA/TudoricaAndrei/test_env/test_env.runs/synth_1/test_env.dcp
  read_xdc D:/Andrei/Scoala/CA/TudoricaAndrei/test_env/test_env.srcs/constrs_1/imports/test_env/basys3.xdc
