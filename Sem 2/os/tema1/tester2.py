...
A1_DATA = ""
A1_PROG = "a1"
VERBOSE = False
VALGRIND = True
TIME_LIMIT = 4
...
def generateTests(data):
    random.seed(data["variant"] + data["name"] + "1a2b3c")
    ...
    #save tests to file
    fout = open("tests2.json", "w")
    json.dump(tests, fout, indent=4)
    fout.close()
    return tests

def loadTests():
    if os.path.isfile("tests2.json"):
        fin = open("tests2.json")
        tests = json.load(fin)
        fin.close()
    else:
